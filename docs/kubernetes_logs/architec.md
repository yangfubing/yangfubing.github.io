...
> 但是，通常来说容器引擎或运行时提供的功能不足以记录完整的日志信息，比如，如果容器崩溃了、Pod 被驱逐了或者节点挂掉了，我们仍然也希望访问应用程序的日志。所以，日志应该独立于节点、Pod 或容器的生命周期，这种设计方式被称为 
...
> ![node agent](../assets/img/kubernetes_logs/logging-with-node-agent.png)
...
> ![sidecar agent](../assets/img/kubernetes_logs/logging-with-streaming-sidecar.png)
...
> ![sidecar agent](../assets/img/kubernetes_logs/logging-with-sidecar-agent.png)
...
> ![app log](../assets/img/kubernetes_logs/logging-from-application.png)
